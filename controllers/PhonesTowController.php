...
use Yii;
use app\models\PhonesTow;
use app\models\PhonesTowSearch;
 ...
 */
class PhonesTowController extends BaseController
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new PhonesTowSearch();
    ...
    {
        if (($model = PhonesTow::findOne($id)) !== null) {
            return $model;
        }

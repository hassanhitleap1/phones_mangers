...
use Yii;
use app\models\PhonesThree;
use app\models\PhonesThreeSearch;
 ...
 */
class PhonesThreeController extends BaseController
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new PhonesThreeSearch();
    ...
    {
        if (($model = PhonesThree::findOne($id)) !== null) {
            return $model;
        }

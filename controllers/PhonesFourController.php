...
use Yii;
use app\models\PhonesFour;
use app\models\PhonesFourSearch;
 ...
 */
class PhonesFourController extends BaseController
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new PhonesFourSearch();
    ...
    {
        if (($model = PhonesFour::findOne($id)) !== null) {
            return $model;
        }
